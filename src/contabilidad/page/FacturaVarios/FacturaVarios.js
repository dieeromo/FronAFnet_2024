...
import ModalCreateFacturaServicios from './components/ModalCreateFacturaServicios';
import ModalPagoFacturaServicios from './components/ModalPagoFacturaServicios';
            ...
            {facturas && facturas.length > 0 ? (
              facturas.map((factura, index) => (
                <tr key={index}>
                  ...
                  <td className="py-2 px-4 border-b text-xs text-center">{factura.proveedorName}</td>
                  <td className="py-2 px-4 border-b text-xs text-center">{factura.servicioName}</td>
                  ...
                  <td className='flex justify-center'>
                    {!factura.pagado && (
                      <ModalPagoFacturaServicios
                        facturaID={factura.id}
                        pendiente={factura.valor - factura.abono}
                      />
                    )}
                  </td>
                  <td className="py-2 px-4 border-b text-xs text-center">{factura.modoCompraName}</td>
                  <td className="py-2 px-4 border-b text-xs text-center">{factura.presupuestoName}</td>
                </tr>
              ))
            ) : (
              <tr>
