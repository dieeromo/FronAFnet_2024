...
export default function NavbarInventario() {
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:block">
              <ul className="flex space-x-4"> 
                <li><a href="/inventario/equipos_todos/" className=" hover:text-gray-300">Equipos</a></li>
                <li><a href='/contabilidad/factura_equipo' className=" hover:text-gray-300">Factura Equipos</a></li>
