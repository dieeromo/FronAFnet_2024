...
import { usePostComunidadesMutation } from '../services/clienteCiudadesApi'

export default function ModalCreateComunidad({ ciudadID }) {
   ...
   // const userDatos = JSON.parse(localStorage.getItem('userDatos') || "{}")
    ...
    const [crearComunidad] = usePostComunidadesMutation()
                    ...
                    <div className="relative w-1/2 mx-auto my-6">
                        ...
                        <div className="bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            <div className="flex items-center justify-between p-5 border-b border-gray-300 border-solid rounded-t">
                                <h3 className="text-lg font-semibold"> Nueva comunidad</h3>
                                <button
                                    onClick={closeModal}
                            ...
                            <form onSubmit={guardarCambios} method='PUT' className='p-5'>
                                ...
                                <div className="grid grid-cols-1  gap-8">
                                    ...
                                    <div className="mb-4 mr-1">
                                        <label className="block text-sm font-semibold text-gray-500  ">Comunidad:</label>
                                        <input
                                            required
                                            type="text"
                                            name="comunidad"
